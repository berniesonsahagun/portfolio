    ...
    <>
        ...
        list={
          <List width={"200px"}>
            ...
            >
              ...
              <List width={"200px"}>
                <List.Item
                  onClick={handleOpenVaporwaveModal as MouseEventHandler}
                ...
                <List.Item
                  onClick={handleOpenTunesModal as MouseEventHandler}
                  icon={<CdMusic variant="16x16_4" />}
                  className="listLink"
                >
            ...
            <List.Item
              ...
              onClick={handleOpenCVModal as MouseEventHandler}
              className="listLink"
            >
              CV{" "}
            </List.Item>
            <List.Item
              ...
              onClick={handleOpenPortfolioModal as MouseEventHandler}
              className="listLink"
            >
              Portfolio{" "}
            </List.Item>
            <List.Item
              ...
              onClick={handleOpenPhotoModal as MouseEventHandler}
              className="listLink"
            >
              Janne
            </List.Item>
            <List.Item
              ...
              onClick={handleOpenSkillsModal as MouseEventHandler}
              className="listLink"
            >
              Skills
            </List.Item>
            ...
            <List.Item
              ...
              onClick={handleOpenAboutModal as MouseEventHandler}
              className="listLink"
            >
              Welcome
            </List.Item>
      ...
      {showPhotoModal && (
        <S.styledModal
          ...
          titleBarOptions={
            <TitleBar.Close
              onClick={handleClosePhotoModal as MouseEventHandler}
              key="close"
            />
          }
      ...
      {showVaporwaveModal && (
        <S.styledModal
          ...
          titleBarOptions={[
            <TitleBar.Close
              onClick={handleCloseVaporwaveModal as MouseEventHandler}
              key="close"
            />,
          ]}
        >
          <S.styledModalFrame bg="white" boxShadow="$in">
            ...
            <hr
              style={{ color: "gray", alignSelf: "flex-start", width: "100%" }}
            />
            <div>
              <iframe
